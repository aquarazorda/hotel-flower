...
export default function Home() {
  return (
    <main class="font-shippori">
      ...
      {/* Main Page Start */}
      <HomeMainBox />
      <div class="flex justify-center px-8 py-12 align-middle lg:h-72">
        <span class="inline-flex self-center text-center text-[12.5px] text-primary lg:max-w-xl lg:text-base lg:text-primary/90">
