...
const MobileFooter = () => (
  <footer class="flex flex-col bg-secondary p-7 text-xs text-white lg:hidden lg:p-16">
    <nav class="flex w-full justify-between">
      <ul class="flex flex-col gap-1 font-semibold lg:text-base lg:font-medium">
        <li>
          <A href="/">Home</A>
        </li>
        <li>
...
const DesktopFooter = () => (
  <>
    <footer class="hidden grow justify-between bg-secondary p-8 pb-4 text-xs text-white lg:flex">
      ...
      <nav class="flex max-h-32 flex-1 justify-center">
        <ul class="flex flex-col gap-1 font-medium lg:text-base">
          <li>
            <A href="/">Home</A>
          </li>
          <li>
