...
export const HomeSlider = () => {
  ...
  return (
    <div>
      ...
      <div class="mb-10 mt-6 flex flex-col p-4 xl:my-20 xl:mb-28 xl:items-center xl:pt-2">
        <span class="text-center text-[12.5px] text-primary xl:max-w-2xl xl:text-base xl:text-primary/90">
