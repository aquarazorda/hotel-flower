      ...
      <div class="flex flex-col xl:flex-row">
        ...
        <div class="mt-5 flex flex-col gap-6 px-4 xl:mt-0 xl:w-1/2 xl:flex-row xl:px-0">
          ...
          <div class="flex flex-col xl:mx-auto xl:w-2/3 xl:justify-center xl:gap-5">
            <span class="hidden text-center font-shippori text-2xl font-medium text-secondary xl:block">Suites</span>
            <span class="text-center text-xs text-neutral-500 xl:text-base">
