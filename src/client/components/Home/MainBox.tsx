...
export const HomeMainBox = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h1 class="hidden bg-text-gradient bg-clip-text p-2 text-center font-shippori text-6xl uppercase leading-extra-tight text-transparent transition lg:block">
          Hotel 
