...
export function CheckRounded(props: JSX.IntrinsicElements["svg"]) {
  return (
    <svg
    ...
    >
      <g fill="currentColor">
        <path d="M16.03 10.03a.75.75 0 1 0-1.06-1.06l-4.47 4.47l-1.47-1.47a.75.75 0 0 0-1.06 1.06l2 2a.75.75 0 0 0 1.06 0l5-5Z" />
        <path
          fill-rule="evenodd"
